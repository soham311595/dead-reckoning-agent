...
Benchmarked on [ToolBench](https://github.com/OpenBMB/ToolBench) `data_example` — 10 real multi-step API tasks across 3 difficulty tiers (G1: 2 APIs, G2: 7 APIs, G3: 11 APIs), with ground-truth evaluation.
